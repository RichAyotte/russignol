...
This project is a static website consisting of HTML and CSS. You can easily develop and preview it locally using [Bun](https://bun.sh/).

### Prerequisites

- **Bun**: Ensure you have the Bun runtime installed.

### Running Locally

To serve the website locally, run the following command in this directory:
